...
public class CustomerController implements Serializable {
    ...
    private String urlRoot ="http://localhost:8080/KiraVision/cardholder/";
...
//System.out.println(agentxml);
    ...
    public String editCustomer(CardHolder holder) {
      System.out.println(holder.getClientEmail());
    ...
    public String saveEditingCustomer()
    {
        CardHolder ch ;
        ch=this.getCardHolder();
        ch.setModifiedOn(new java.util.Date());
   ...
   //  System.out.println(xml);
     ...
     {
      FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_FATAL, "Fatal!", "The Customer Could not be edited. See administrator to check."));
